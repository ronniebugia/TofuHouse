...
<section class="card">
  ...
  <div class="card--content bgimg-3 w3-animate-top">
    <div style="padding:64px">
        <h1 style="font-size: 2.5em"><b>Ongoing Projects</b></h1> 
        <h2 class="hover-effect1" onclick="plusDivs(1)" style="cursor: pointer; font-size:4vh">Evolution Dental Studio</h2>
        <h2 class="hover-effect1" onclick="plusDivs(2)" style="cursor: pointer; font-size:4vh">Ubuntu String Quartet</h2>
        <h2 class="hover-effect1" style="cursor: pointer; font-size:4vh">UBC BAJA</h2>
        <h2 class="hover-effect1" style="cursor: pointer; font-size:4vh">UBC Trading Group</h2>
    </div>
  </div>
